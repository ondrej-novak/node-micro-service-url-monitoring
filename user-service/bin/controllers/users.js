        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _b = (_a = res).send;
                        return [4 /*yield*/, user_1.userService.list()];
                    case 1:
                        _b.apply(_a, [_c.sent()]);
                        return [2 /*return*/];
                }
    ...
    UsersController.prototype.getById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, user_1.userService.getById(req.params.id)];
                    case 1:
                        user = _a.sent();
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _b = (_a = res).send;
                        return [4 /*yield*/, user_1.userService.update(__assign({}, req.body, { id: req.params.id }))];
                    case 1:
                        // update enpoint store it into DB
                        _b.apply(_a, [_c.sent()]);
                        return [2 /*return*/];
