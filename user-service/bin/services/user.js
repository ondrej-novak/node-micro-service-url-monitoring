...
var UserService = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        connection = _a.sent();
                        return [4 /*yield*/, connection.getRepository(user_1.User).findOne(id)];
    ...
    UserService.prototype.update = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var connection, repository, userToModify;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log(user);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        item = _a.sent();
                        return [4 /*yield*/, connection.getRepository(user_1.User).remove(item)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
